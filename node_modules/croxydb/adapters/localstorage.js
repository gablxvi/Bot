...
class WebDB {
    ...
    set(db, data, content, this.seperator);
  ...
  get(db) {
    ...
    return get(content, this.seperator, ...db.split(this.seperator));
  ...
  has(db) {
    ...
    return get(content, this.seperator, ...db.split(this.seperator)) ? true : false;
