...
class JsonDB {
    ...
    functions.set(db, data, content, this.seperator);
  ...
  get(db) {
    ...
    try {
      return functions.get(content, this.seperator, ...db.split(this.seperator));
    } catch(err) {
      return undefined;
    }
  ...
  has(db) {
    ...
    try {
      return functions.get(content, this.seperator, ...db.split(this.seperator)) ? true : false;
    } catch(err) {
      return false;
    }
  ...
  delete(db) {
    ...
    functions.remove(content, db, this.seperator);
